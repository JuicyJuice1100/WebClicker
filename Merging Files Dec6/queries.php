<?php
    ...
    *******************************************************************************/
    ...
    $averagePoints, $startTime, $endTime, $questionStatus, $questionType) {
        ...
        try {
            ...
            $topicDescription, $keyword, $sectionNumber, $phpGraderCode,
            $numberofCorrectAnswers, $averagePoints, $startTime, 
    ...
    function changeQuestionStatus($id, $status){
        ...
        try{
            $query = "UPDATE Question
                ...
                WHERE QuestionId = $id";
                //$stmt = $db->prepare($query; CHANGEMADE
                $stmt = $db->prepare($query);
                $stmt->execute();
                return true;
        } catch (PDOException $e){
    ...
    *******************************************************************************/
    ...
    //Added line 220 and 221 CHANGEMADE
    global $db;
        try {
        $query = "UPDATE Student
