...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a href="sign_in.html">Log out</a>
                </li>
                <li><a href="change_password_instructor.html">Edit Account</a>
                </li>
                <li class="selected"><a href="add_new_question_instructor.html">Add New Question</a>
                </li>
                <li><a href="questions_instructor.php">Questions</a>
                </li>
            </ul>
        </nav>
    </header>
