...
<body>
 ...
 <div id="content">
	 ...
	 <div class="question_in_review">
			<h1> Q<?php echo $question['QuestionId']; ?> - Section <?php echo $question['SectionNumber']; ?></h1>
			<p>Description: Need to add description column in database for this and for list of questions page. 
			right now its the generated html so how do we insert here? Also. What about listing all the answers here or 
			the correct answer? I think for grading we are storing 1-4 for correct so that does no good here. Think about editing too.
			</p>
			<div class="centered">
